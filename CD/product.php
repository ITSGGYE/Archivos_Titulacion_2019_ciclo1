...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="product.php"><i class="icon-th-list"></i>Productos</a>
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php" class="active" style="color:#111;">Bebidas</a></li>
			<li>|</li>
			<li><a href="football.php">Snacks</a></li>
			<li>|</li>
			<li><a href="running.php">Cigarrillos y Caramelos</a></li>
		</ul>
