...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="Cigarrillos y Caramelos"></td>
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Cigarrillos y Caramelos</h2></center></div>
			<br />
 ...
 $row = mysqli_fetch_array($result);
  ...
  header("Location:admin_cigarrillos.php");
 }
 ...
 $row = mysqli_fetch_array($result);
  ...
  header("Location:admin_cigarrilllos.php");
 }
  ?>
