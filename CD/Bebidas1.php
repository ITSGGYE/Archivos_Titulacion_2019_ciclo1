...
<div id="container">
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				<li><a href="Bebidas1.php" class="active" style="color:#111;">Bebidas</a></li>
				<li>|</li>
				<li><a href="Snacks1.php">Snacks</a></li>
				<li>|</li>
				<li><a href="Cigarrillos1.php">Cigarrillos y Caramelos</a></li>
			</ul>
				<?php echo "<a href='cart.php?id=".$id."&action=view'><button class='btn btn-inverse' style='right:1%; position:fixed; top:10%;'><i class='icon-shopping-cart icon-white'></i> Ver carrito</button></a>" ?>
		</div>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php
				...
				$query = mysqli_query($conn, "SELECT *FROM product WHERE category='Bebidas' ORDER BY product_id DESC") or die (mysqli_error());
