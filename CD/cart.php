...
<body>
	...
	<div id="Perfil" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					<button type="button" class="cerrar" data-dismiss="modal" aria-hidden="true">x</button>
...
<div id="container">
	...
	<form method="post" class="well" action="cart.php?action=view" style="background-color:#fff;">
	<table class="table">
...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><strong><h3 class='text-danger'>$ ".$total."</h3></strong></td>";
		echo "<td><input style='width:2px;' type='hidden' value='".$total."' required name='total'></td>";
...
?>
	...
	<a href='home.php' class='btn btn-inverse btn-lg'>Seguir comprando</a>
	<?php if ($action == "empty") {
		echo "";
	}else{
		echo "<button name='pay_now' type='submit' class='btn btn-inverse btn-lg' >Finalizar compra</button>";
