...
<html lang="en">
  <head>
    ...
    <title>.: Dr. Erazo :.</title>

    <link rel="icon" type="image/x-icon" href="img/dientes.png">
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Centro Odontologico Dr. Erazo <sup><small><span class="label label-info"></span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=report_hc"><i class="fa fa-users"></i> Reporte HC </a></li>
          <li><a href="index.php?view=report"><i class="fa fa-users"></i> Reporte de Citas Diarias </a></li>
        <?php endif;?>
          </ul>
