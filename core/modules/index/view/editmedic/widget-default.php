...
<div class="row">
    ...
    <div class="col-md-6">
        <input readonly="" onkeyup="Mayus(this);" onkeypress="return soloNombres(event)" type="text" name="name" value="<?php echo $user->cedula;?>" class="form-control" id="name" placeholder="Nombre">
    </div>
  </div>                  
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Nombre*</label>
    <div class="col-md-6">
      <input onkeyup="Mayus(this);" onkeypress="return soloNombres(event)" type="text" name="name" value="<?php echo $user->name;?>" class="form-control" id="name" placeholder="Nombre">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Apellido*</label>
    <div class="col-md-6">
      <input onkeyup="Mayus(this);" onkeypress="return soloNombres(event)" type="text" name="lastname" value="<?php echo $user->lastname;?>" required class="form-control" id="lastname" placeholder="Apellido">
    </div>
  </div>
  <div class="form-group">
