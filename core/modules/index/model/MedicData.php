...
class MedicData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (cedula,name,lastname,address,phone,email,created_at) ";
		$sql .= "value (\"$this->cedula\",\"$this->name\",\"$this->lastname\",\"$this->address\",\"$this->phone\",\"$this->email\",$this->created_at)";
		Executor::doit($sql);
	}
