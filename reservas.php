...
<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "auditoria.php"><i class = "glyphicon glyphicon-th"></i> Auditoria</a></li>
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<div class = "alert alert-info">Transacción / Reserva</div>
				<form method = "POST" action = "reservas_insert.php" enctype = "multipart/form-data">
					...
					<div class = "form-group pull-right">
						...
						<button name = "save_borrow" class = "btn btn-primary"><span class = "glyphicon glyphicon-thumbs-up"></span> Reservar</button>
					</div>
					<br><br><br><br><br>
