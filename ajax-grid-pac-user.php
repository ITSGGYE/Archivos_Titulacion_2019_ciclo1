...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
                     <a href="editar_pac_user.php?id='.$row['id_paciente'].'"  data-toggle="tooltip" title="Editar datos" class="btn btn-sm btn-info"> <i class="menu-icon icon-pencil">Modificar</i> </a>
				     </center></td>';		
