...
?>
    ...
    <head>
        ...
        <script language="Javascript">
          function imprSelec(subjectresult) {
            var ficha = document.getElementById(subjectresult);
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Finalizar año Lectivo</h1>
                    </div>
                        ...
                        <div class="col-md-12">
                            <fieldset class="scheduler-border">
                                ...
                                <form class="form-inline" role="form" id="searchform">
                                    ...
                                    <!--<button type="button" class="btn btn-success btn-sm" id="find" onclick="javascript:GetFeeForm(3)"> Cerrar Año </button>-->
                                    <!--<a href="reportCourse.php?action=edit&amp;id=4" class="btn btn-success btn-sm">Cerrar Año</a>-->
                                    <a href="javascript:imprSelec('subjectresult')" class="btn btn-success btn-sm">Cerrar Año</a>
                                </form>
                            </fieldset>
