<html>
    <head>
        ...
        <script src="../js/listadoAsistenciaFamiliar.js" type="text/javascript"></script>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../DOCENTE/MenuPrincipal.php">
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h4 mb-2 text-gray-800">
                            <div class="form-inline">
                                ...
                                <div class="col-sm-2">
                                    <h6 style="margin-top: 12px;color:#8c8c8c">Listado</h6>   
                                </div>
                            </div>
                        </h1>
                            ...
                            <div class="card-body">
                                <div class='col-md-12'>
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-inline">
                                            ...
                                            <div class="col-sm-4">
                                                <input type='text' class='form-control' id="nombreEstudiante" placeholder="Ingrese nombres completos en mayuscula">
                                            </div>
                                            <br><br><br><br>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary" onclick="BuscarEstudiante()" ><i class="fa fa-search"></i></button>
                                            </div>
                                ...
                                <div class='col-md-12'>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody id="Listado_AsistenciaFamiliar">
