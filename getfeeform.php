...
echo '<form class="form-horizontal" id ="signupForm1" action="cobros.php" method="post">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Total General:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Valor a pagar:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="submitdate"  id="submitdate" value="'.$fechaactual.'" readonly/>
...
echo '
<h4>Informacion de Estudiante</h4>
