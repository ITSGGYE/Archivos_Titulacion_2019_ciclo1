...
<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "auditoria.php"><i class = "glyphicon glyphicon-th"></i> Auditoria</a></li>
			...
			<div class = "col-lg-9 well" style = "margin-top:70px;">
				<div class = "alert alert-info">AUDITORIA</div>
					...
					<div id = "student_table">
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php
									$qstudent = $conn->query("SELECT * FROM `auditoria` ORDER BY id DESC") or die(mysqli_error());
									while($fstudent = $qstudent->fetch_array()){
								?>
								<tr>
									<td><?php echo $fstudent['id']?></td>
									<td><?php echo $fstudent['action']?></td>
