...
if (!empty($requestData['search']['value'])) {
    ...
    $sql = "SELECT id_paciente, nombrepac, fechanac, especie, sexo, raza, peso,foto ";
    $sql .= " FROM paciente";
...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
    ...
    $cont++;
    $nestedData[] = $cont;
    $nestedData[] = '<td><center><img width="100px" heigth="100px" src ="/var/www/html/imagenes/pacientes/' . $row['foto'] . '"></center></td>';
    ...
    $nestedData[] = '<td><center>
                     <a href="editar_pac_vet.php?id=' . $row['id_paciente'] . '"  data-toggle="tooltip" title="Editar datos" class="btn btn-sm btn-info"> <i class="menu-icon icon-pencil">Modificar</i> </a>
				     </center></td>';
