<%@page import="Clases.InventarioPedidos"%>
<%@page import="Models.ModelsConsultarCompraProductos"%>
...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed" id="Pedidos">
        <div class="wrapper">
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="ListadoPedidosCompra.jsp" class="nav-link active">
                                    <i class="nav-icon fas fa-table"></i>
                                    <p>
                            ...
                            <section class="col-lg-12" style='margin-top:10px;'>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <%
                                        ...
                                        ArrayList<InventarioPedidos> objPeticiones = ModelsConsultarCompraProductos.ListadoInventarioPedidos();
                                    ...
                                    <tbody class="buscar">
                                        <tr>
                                            ...
                                            <td><%=c.getUsuario()%></td>
                                            <td><%=c.getCantidadProducto()%></td>
                                            <td><%=c.getPrecioProducto()%></td>
                                            <td><%=c.getValorTotal()%></td>
                                            <td><%=c.getFechaPedido()%></td>
                                        </tr>
                                    </tbody>
                                    <%}%> 
                                </table>
