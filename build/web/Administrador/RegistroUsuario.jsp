                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="RegistroUsuario.jsp" class="nav-link active">
                        ...
                        <div class="row">
                            ...
                            <section class="col-lg-12" style='margin-top:10px;'>
                                ...
                                <div class="form-group">
                                    <center>
                                    <div class="col-lg-7" style="background: white;padding: 15px;border:1px solid #42515f">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    <label>Usuario:</label>
                                            ...
                                            <div class="col-sm-offset-3">
                                                <button type="button" class="btn btn-success" onclick="GuardarUsuario()"><i class="fa fa-save"></i> Registrar</button>
                                            </div>
                                        </div>
                                    </div>
                                    </center>
