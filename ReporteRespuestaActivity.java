...
public class ReporteRespuestaActivity extends AppCompatActivity {
    ...
    private ReporteRespuestaActivity context;

    private String username;

    private ListView listView;
    ArrayList<Question> dataModels;
    private static CustomAdapterQuery adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporte_respuesta);
        ...
        adapter= new CustomAdapterQuery(dataModels,getApplicationContext());
        ...
        new ReporteRespuestaActivity.ServiceQueryStubAsyncTask(context, context).execute();
    }
