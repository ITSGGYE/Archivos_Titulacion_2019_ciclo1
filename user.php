...
<tr>
  ...
  <td>
    <select name="user" onChange="window.open(this.options[this.selectedIndex].value,'_self')">
      ...
      <option value="reg_asist.php">USUARIO</option>
...
<tr>
  ...
  <td><input type="password" name="pasadmin" value="" placeholder="" size="45" required></td>
 
</tr>
<tr>
  <td class="tdatos">Repetir Password:</td>
  <td><input type="password" name="" value="" placeholder="" size="45"></td>
