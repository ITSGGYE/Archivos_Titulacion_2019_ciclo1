...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2019 a las 22:39:22
...
INSERT INTO `usuarios` (`u_codigo`, `usuario`, `password`, `status`, `nivel`) VALUES
(1, 'administrador', '1234', 'A', 1);
...
--
ALTER TABLE `usuarios`
  MODIFY `u_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
