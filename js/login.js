$(document).ready(function(){
	$error = $('<center><label class = "text-danger">Por favor complete los campos</label></center>');
	$error1 = $('<center><label class = "text-danger">El usuario o la contraseña es incorrecta</label></center>');
