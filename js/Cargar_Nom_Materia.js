        ...
        success: function (datos) {
            ...
            if (idRango == "") {
                ...
                datos.forEach(function (datos) {
                    ...
                    tr += "<a style='cursor:pointer;text-decoration:none;color:#000' href='../DOCENTE/IngreseNotasEstudiantes.php?id1=" + datos.idseq_calif + "&id2=" + datos.idcurso + "&id3=" + datos.idmateria + "&id4="+idRango+"&id5="+idseq_profesor+"&nom="+datos.nombrecurso+"&id6="+datos.idPeriodo+" '>" + datos.nombreParcial + "</a>";
                    tr += "</td>";
                    tr += "</tr>";
