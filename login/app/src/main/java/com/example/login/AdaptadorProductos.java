...
public class AdaptadorProductos extends RecyclerView.Adapter<AdaptadorProductos.ProductosViewHolder> {
    ...
    Button btnVerCarro;
    List<Productop> listaProductos;
    List<Productop> carroCompra;

    public AdaptadorProductos(Context context, TextView tvCantProductos, Button btnVerCarro, List<Productop> listaProductos, List<Productop> carroCompra) {
