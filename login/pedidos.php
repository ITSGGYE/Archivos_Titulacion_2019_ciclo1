...
<head>
    ...
    <script src="../admin/comentarios/Mis_funciones.js"></script>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">
                            <small><img src="../admin/images/logo.png"></small> Listado de Prestamos
                        </h2>
                    </div>
                </div>
                <!-- /.row -->
...
$registro = mysqli_query($conexion, "SELECT prestamo_libro.id_prestamo as prestamo, libros.disponible as disponible, prestamo_libro.fecha_prestamo as fecha1, prestamo_libro.fecha_entrega as fecha2, 
                         libros.nombre as nombre, usuario_estudiante.nombre as estudiante,
                          prestamo_libro.estado as estado, usuario_estudiante.carnet as carnet
                          from prestamo_libro
                          inner join libros on prestamo_libro.id_libro = libros.id_libro
                         inner join usuario_estudiante on prestamo_libro.id_usuario_estudiante = usuario_estudiante.id_usuario_estudiante where carnet='$nombre'" )
                          or die(mysqli_error());
...
if(mysqli_num_rows($registro)>0){
  while($registro2 = mysqli_fetch_assoc($registro)){
    ...
    echo '<tr';
   switch($estado){
    case 0:echo ' style="background:white; color:blue;"';break;
