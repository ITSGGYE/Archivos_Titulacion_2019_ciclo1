		...
		<ul id="plans">
			<li class="plan">
				<ul class="planContainer">
					...
					<li class="button"><a href="reg_historial.php">Registrar</a></li>
				</ul>
			</li>
			...
			<li class="plan">
				<ul class="planContainer">
					...
					<li class="button"><a class="bestPlanButton" href="act_historial.php">EDITAR</a></li>
				</ul>
			</li>
			...
			<li class="plan">
				<ul class="planContainer">
					...
					<li class="button"><a href="busc_historial.php">BUSCAR</a></li>
				</ul>
			</li>
			...
			<li class="plan">
				<ul class="planContainer">
					...
					<li class="button"><a class="bestPlanButton" href="../mod_configuracion/login.php">CERRAR</a></li>
				</ul>
			</li>
		</ul> <!-- End ul#plans -->
	</section>
