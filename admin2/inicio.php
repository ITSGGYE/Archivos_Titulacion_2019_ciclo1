...
<body>
    <div id="wrapper">
        ...
        <!--/. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a   href="habitacion.php"><i class="fa fa-pencil-square-o"></i> Eliminar habitación
</a>
                    </li>
                       <li>
                    ...
                    <li>
                        <a  href="mensajes.php"><i class="fa fa-desktop"></i> Boletines_informativos</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
				...
				<?php
						include ('db.php');
						$sql = "select * from habitacionbook";
  ...
  <span class="badge"><?php echo $c ; ?></span>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
									...
									<?php
									$tsql = "select * from habitacionbook";
									...
									{	
										...
										if($co=="Not Conform")
										{
											echo"<tr>
												...
												<th><a href='habitacionbook.php?rid=".$trow['id']." ' class='btn btn-primary'>Action</a></th>
												</tr>";
										}	
                      ...
                      <!-- End  Basic Table  --> 
								...
								$rsql = "SELECT * FROM `habitacionbook`";
 ...
 <span class="badge"><?php echo $r ; ?></span>
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
                                        <div class="panel-body">
										<?php
										$msql = "SELECT * FROM `habitacionbook`";
                            ...
                            <div class="table-responsive">
								...
								<a href="mensajes.php" class="btn btn-primary">Más acción
</a>
                            </div>
                        </div>
                    </div>
