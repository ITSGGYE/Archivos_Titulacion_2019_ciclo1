        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="libro_habitaciones.php"><i class="fa fa-bar-chart-o"></i> Reserva de habitacion</a>
                    </li>
                    <li>
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='inicio.php'</script>";
												 $type_of_room = 0;       
														...
														$psql = "INSERT INTO `pago`(`id`, `title`, `fname`, `lname`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`meal`, `mepr`, `btot`,`fintot`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$troom','$bed','$nroom','$cin','$cout','$ttot','$meal','$mepr','$btot','$fintot','$days')";
														...
														{	$notfree="NotFree";
															...
															echo "<script type='text/javascript'> window.location='libro_habitaciones.php'</script>";
															}
