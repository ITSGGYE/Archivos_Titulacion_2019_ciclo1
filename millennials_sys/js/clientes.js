 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			var edad_cliente = $("#edad_cliente"+id).val();
			var email_cliente = $("#email_cliente"+id).val();
			var genero_cliente = $("#genero_cliente"+id).val();
			var frecuente_cliente = $("#frecuente_cliente"+id).val();
			var marketing_cliente = $("#marketing_cliente"+id).val();
			...
			$("#mod_edad").val(edad_cliente);
			$("#mod_email").val(email_cliente);
			$("#mod_genero").val(genero_cliente);
			$("#mod_frecuente").val(frecuente_cliente);
			$("#mod_marketing").val(marketing_cliente);
