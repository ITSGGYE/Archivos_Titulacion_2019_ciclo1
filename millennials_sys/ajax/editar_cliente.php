...
?><?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET Cli_Nombre='".$nombre."',Cli_Apellido='".$apellido."',Cli_Edad='".$edad."', Cli_Numero='".$telefono."', Cli_Correo='".$email."' , Cli_Estado='".$estado."' WHERE Cli_Id='".$id_cliente."'";
