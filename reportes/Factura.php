...
function fact_dev( $libelle, $num )
{
    ...
    $texte  = $libelle . utf8_decode(" N°:003-") . $num;    
    $szfont = 14;
    $loop   = 0;
...
// agrega una línea a la factura / estimación
...
// rellena los cuadros de IVA / Totales y el comentario
...
// agregue una marca de agua (estimación temporal, DUPLICATA ...)
// llama a este método primero
function temporaire( $texte )
{
