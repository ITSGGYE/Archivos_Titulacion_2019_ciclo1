<html>
    <head>
        ...
        <script src="../js/EditarEstudiante.js" type="text/javascript"></script>
    ...
    <body id="page-top">
        ...
        require '../Models/ModelConsultaIdEstudiante.php';
        ...
        $id= $_GET['id'];
        $data = ConsultaEstudianteId($id,$conexion);
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <h4 class="m-2 font-weight-bold text-primary">Registrar Alumno</h4>
                                    <br>
                                     <input type="hidden" id="idEstudiante" value=">?= $id ?>">
                                    <div class="form-group">
                                        <label>Nombres:</label>
                                        <input type="text" class="form-control" id="nombresEstudiante" value="<?=$data["nombresEstudiante"] ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Edad:</label>
                                        <input type="text" class="form-control" id="edad" value="<?=$data["edad"] ?>">
                                        
                                    </div>
                                    <div class="form-group">
                                        <label>Nombre Representante:</label>
                                        <input type="text" class="form-control" id="nombresRpte" value="<?=$data["nombresRpte"] ?>">
                                    </div>
                                    <input type="hidden" id="usuario" value="<?= $nombre ?>">
                                    <input type="hidden" id="fecharegistro" value="<?= $fecharegistro ?>">
                                    <div>
                                        <button class="btn btn-primary" onclick="ModificarEstudiante()" style="float: right;"><i class="fa fa-save"></i> Guardar</button>
                                    </div>
