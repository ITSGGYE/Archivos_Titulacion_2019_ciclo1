<html>
    <head>
        ...
        <script src="../js/CamposNotasEdit.js" type="text/javascript"></script>
        <script src="../js/GuardarNotaEdit.js" type="text/javascript"></script>
    ...
    <body id="page-top">
        ...
        $idEstudiante = $_GET['id1'];
        $idcurso = $_GET['id2'];
        $idPeriodo = $_GET['idN3'];
        $idRango = $_GET['idN4'];
        $idmateria = $_GET['idN5'];
        $idseq_profesor = $_GET['idN6'];
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <input type='hidden' id='idseq_profesor' value="<?=$idseq_profesor ?>">
                                <div>
                                ...
                                <div>
                                        <button class="btn btn-primary" onclick="GuardarModNotas()" style="float: right;"><i class="fa fa-save"></i> Guardar</button>
                                </div>
                            </div>
