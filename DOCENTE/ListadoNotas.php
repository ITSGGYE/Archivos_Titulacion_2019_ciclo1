<html>
    <head>
        ...
        <script src="../js/ListadoEstudiantesNotas.js" type="text/javascript"></script>
        <script src="../js/Consulta_notas_Estudiante.js" type="text/javascript"></script>
        <script src="../js/ConsultaPromediosFinales.js" type="text/javascript"></script>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body" id="listado">
                                ...
                                <div class="col-md-12" style='margin-top: 20px;'>
                                    <div class="form-inline">
                                        ...
                                        <div class="col-sm-1">
                                            <button  class="btn btn-primary" onclick="BuscarEstudiantes()" id="btnEstudiante"><i class="fa fa-search"></i></button>
                                        </div>
                                        <div class="col-sm-2">
                                            <button class="btn btn-primary" onclick="VerPromedio()"><i class="fa fa-list">Ver Promedio</i></button>
                                        </div>
                                ...
                                <div class='col-md-12' id="tablaEstudy">
                                    <table class="table table-bordered" id="ListadoEstudianteNotas" style="margin-top: 15px;boder:1px solid silver" >
                            ...
                            <div class="card-body" id="tablaNotas" style="display: none;">
                                <div class='form-inline'>
                                    <div class='col-md-6'>
                                        <h4 class="m-2 font-weight-bold text-primary"> <i class='fa fa-book'></i> Listado</h4>
                                    </div> 
                                    <div class='col-md-6'>
                                        <button class="btn btn-primary" id="Regresar1"><i class="fa fa-arrow-circle-left"></i> Regresar</button>
                                    </div> 
                                </div>

                                <div class='col-md-12'>
                                    <table class="table table-responsive" id="tablaNotasEstudiante" style="margin-top: 15px;boder:1px solid silver" >
                            ...
                            <div class="card-body" id="listadoPromedio" style="display: none;">

                                <div class='form-inline'>
                                    <div class='col-md-6'>
                                        <h4 class='m-2 font-weight-bold text-primary'><i class='fa fa-book'></i> Listado Promedio Estudiantes</h4>
                                    </div>
                                    <div class='col-md-2'>
                                        <button class='btn btn-primary' id='Regresar'><i class='fa fa-arrow-circle-left'></i> Regresar</button>
                                    </div>
                                </div>
                                <div class='col-md-12' id='TablaPromedio'>
