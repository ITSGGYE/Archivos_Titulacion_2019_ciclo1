<html>
    <head>
        ...
        <title>Editar Modelo Calificación</title>
        <script src="../vendor/jquery/jquery.min.js"></script>
        <script src="../js/ModificarModelCalificacion.js" type="text/javascript"></script>
    ...
    <body id="page-top">
        ...
        require '../Models/ConsultaModeloCalificacionId.php';
        ...
        $id= $_GET['id'];
        $data = ConsultaIdModelCalificacion($id,$conexion);
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                    <div class="form-inline">
                                        ...
                                        <div class="col-sm-6">
                                            <h6 class="m-0 font-weight-bold text-primary">Modificar modelo de calificaciones</h6>
                                   
                                        </div>
                                        <div class="col-sm-6" style="color: white;">
                                            <a class="btn btn-primary" style="cursor: pointer;" href="ConfiguracionNotas.php"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
                                        </div>
                                </div>

                                     <br>
                                    <input type="hidden" id="idseq_calif" value="<?= $id ?>">
                                    
                                    <div class="form-group">
                                        <label>nombre:</label>
                                        <input type="text" class="form-control" id="nombrecalif" value="<?=$data["nombrecalif"] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Descripción:</label>
                                        <input type='text' class="form-control" id="descripcioncalif" value="<?=$data["descripcioncalif"] ?>">
                                    </div>
                                    <div>
                                        <button class="btn btn-primary" onclick="ModificarDatos()" style="float: right;"><i class="fa fa-save"></i> Guardar</button>
                                    </div>
