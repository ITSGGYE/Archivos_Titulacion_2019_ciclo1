<html>
    <head>
        ...
        <title>Ingresar Notas Estudiante</title>
        <script src="../vendor/jquery/jquery.min.js"></script>
        <script src="../js/Cargar_Nom_Materia.js" type="text/javascript"></script>
        <script src="../js/CargarID_ModCalificacion.js" type="text/javascript"></script>
        <script src="../js/consulta_List_Estudiantes.js" type="text/javascript"></script>
        <script src="../js/Guardar_Notas_Estudiante.js" type="text/javascript"></script>
    ...
    <body id="page-top">
        ...
        $idseq_calif = $_GET['id1'];
        $idcurso = $_GET['id2'];
        $idmateria = $_GET['id3'];
        $idRango = $_GET['id4'];
        $idProfesor = $_GET['id5'];
        $nombrecurso = $_GET['nom'];
        $idPeriodo = $_GET['id6'];
        ?>
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h4 mb-2 text-gray-800">
                            <div class="form-inline">
                                ...
                                <div class="col-sm-2">
                                    <h6 style="margin-top: 12px;color:#8c8c8c">Ingreso de Notas</h6>   
                                </div>
                            </div>
                        </h1>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                <div class="form-inline">
                                        ...
                                        <div class="col-sm-6">
                                            <h4>Alumnos del curso <?= $nombrecurso ?> </h4>
                                        </div>
                                        <div class="col-sm-6" style="color: white;">
                                            <a class="btn btn-primary" style="cursor: pointer;" href="IngresoNotas.php"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-inline">
                                        <div class="col-md-8">
                                            <table class="table table-bordered" >
                                                <thead style="text-align: center;">
                                                    <tr>
                                                        ...
                                                        <th style='visibility: hidden'>Profesor</th>
                                                    </tr>
                                                </thead>
                                            ...
                                            <div class='col-md-6'>
                                                <button class="btn btn-primary" onclick="GuardarEstudianteNota()"><i class="fa fa-save"></i> Guardar</button>
                                            </div>
                                        </div>

                                        <div class="col-md-4" style="border: 1px solid #8c8c8c">
                                            <input type="hidden" id="idseq_calif" value="<?= $idseq_calif ?>">
                                            <input type="hidden" id="idcurso" value="<?= $idcurso ?>">
                                            <input type="hidden" id="idmateria" value="<?= $idmateria ?>">
                                            <input type="hidden" id="idRango" value="<?= $idRango ?>">
                                            <input type="hidden" id="idProfesor" value="<?= $idProfesor ?>">
                                            <input type="hidden" id="idPeriodo" value="<?= $idPeriodo ?>">
                                            <h4><i class="fa fa-book"></i> Sub Notas</h4>

                                            <div id="tablaListadoParciales" >
