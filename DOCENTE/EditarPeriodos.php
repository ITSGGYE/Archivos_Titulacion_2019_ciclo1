<html>
    <head>
        ...
        <script src="../js/ModificarPeriodo.js" type="text/javascript"></script>
    ...
    <body id="page-top">
        ...
        require '../Models/ModelConsultaIdPeriodo.php';
        ...
        $id= $_GET['id'];
        $data = ConsultaPeriodoId($id,$conexion);
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <br>
                                    <input type="hidden" id="idPeriodo" value="<?= $id ?>">
                                    <div class="form-group">
                                        <label>Periodo:</label>
                                        <input type="text" class="form-control" id="nombrePeriodo" value="<?=$data["nombrePeriodo"] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Duración(En semanas):</label>
                                        <input type="text" class="form-control" id="duracionPeriodo" value="<?=$data["duracionPeriodo"] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Año:</label>
                                        <input type="text" class="form-control" id="añoPeriodo" value="<?=$data["YearPeriodo"] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Descripción:</label>
                                        <input type="text" class="form-control" id="descripcionPeriodo" value="<?=$data["descripcionPeriodo"] ?>">
                                    </div>
                                    
                                    <input type="hidden" id="usuario" value="<?= $nombre ?>">
                                    <input type="hidden" id="fecharegistro" value="<?= $fecharegistro ?>">
                                    <div>
                                        <button class="btn btn-primary" onclick="ModificarPeriodo()" style="float: right;"><i class="fa fa-save"></i> Guardar</button>
                                    </div>
                                </div>
