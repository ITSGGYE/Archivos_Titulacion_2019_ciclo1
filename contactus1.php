		...
		<div id="content">
			<form method="post">
				<table style="position:relative; left:25%;">
					<tr>
                                            <td style="font-size:20px;">Email:</td><td><input type="email" name="email" value="<?php echo $fetch['email']; ?>" style="width:400px;" readonly=""></td>
					</tr>
					<tr>
						<td style="font-size:20px;">Descripción:</td><td><textarea name="Descripción" style="width:400px; height:300px;" required></textarea></td>
					</tr>
					<tr>
