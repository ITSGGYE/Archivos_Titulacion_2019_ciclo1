...
function calculaedad($fechanacimiento){
  ...
  return $ano_diferencia;
						...
						$sql="SELECT a.cedula_alumno, a.nombre_alumno, a.apellido_alumno, a.fechanac_alumno, img.nombre  from datos_alumno a , curso_alumno ca, img_datosalumno img where
						    ca.fk_cursoparalelo='$curso' and ca.fk_alumno=a.cedula_alumno and ca.fk_anio='$idanio' and img.id_imagen=a.imagen_alumno order by a.apellido_alumno";
						$result=mysqli_query($conexion,$sql);
						while($mostrar=mysqli_fetch_row($result)){
							$i++;
	...
	?>
				<tr>
 				...
 				<td> <p><?php echo $mostrar[2].' '.$mostrar[1];?></p> </td>
  				<td> <p><?php echo calculaedad($mostrar[3]).' años';?></p> </td>
