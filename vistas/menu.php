...
?>
 <li class="nav-item active">
  ...
  <li class="nav-item active">
        <a class="nav-link" href="CursoParalelo.php">Cursos <span class="sr-only">(current)</span></a>
  </li>
  <li class="nav-item active">
        <a class="nav-link" href="pensumacademico.php">Tutor <span class="sr-only">(current)</span></a>
  </li>
  <li class="nav-item active">
