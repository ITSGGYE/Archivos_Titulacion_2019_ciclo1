...
function valida(f) {
 ...
 if(f.elements["usuario"].value.length!=8)  
  {
  
    ok = false;
    alertify.error("El campo usuario debe contener 8 caracteres");
  }
  ...
  if(f.elements["password"].value.length!=8)  
  {
    ...
    ok = false;
    alertify.error("El campo password debe contener 8 caracteres");
  }
