        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content">
                    <div class="page_link"> 
                        <a>Lista de Promociones </a>
                        <button onclick="<?php echo "window.location.href = '" . $helper->url('promociones', 'nuevo') . "';" ?>" class="genric-btn success small">Registar nuevo</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="progress-table-wrap"> 
                <div class="progress-table"> 
                    <div class="table-head"> 
                        ...
                        <div class="serial">Precio Normal</div>
                        <div class="serial">% Descuento</div>
                    ...
                    <?php foreach($pros as $pro) {?>
                        <div class="table-row">
                            ...
                            <div class="serial"><?php echo $pro['porcentaje'] ?></div>
                            <div class="visit"><img style="height: 38px; width: 32px;" src="<?php echo RUTAIMGPRODUCTOS.DIRECTORY_SEPARATOR.$pro['imagen']; ?>" alt="---"> </div>
                            <div class="visit">
                                <a href="<?php echo $helper->url('promociones', 'modificar'); ?>&id=<?php echo $pro["id"]; ?>" class="genric-btn info-border small">
                                    <span class="lnr lnr-pencil"></span>
                                </a>
                                <a style="margin-right: 6px">
                                <a onclick="<?php echo "if(confirm('Operacion irreversible: ¿Seguro de eliminar esta promocion?')) window.location.href = '" . $helper->url('promociones', 'borrar') . "&id=" . $pro['id'] . "';" ?>" class="genric-btn danger-border small">
