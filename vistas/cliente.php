<?php 
//activamos almacenamiento en la memoria 
ob_start();
session_start();
  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="number" name="num_documento" id="num_documento" maxlength="13" placeholder="Número de Documento">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
