				...
				<div class="card" style="margin-top: 30px; margin-bottom: 30px;">
  					<h5 class="card-header">FICHA DE MATRICULACION</h5>
  						<div class="card-body">
							...
							<?php
							$sql2="SELECT anio_lectivo  from aniolectivo where id_aniolectivo='$anio'";
										...
										<?php  if ($tipo_alumno==1){
											...
											<option  value="2">Antiguo </option>';
												...
												if ($tipo_alumno==2) {
													...
													<option selected="selected" value="2">Antiguo </option>';
												}
											}
						...
						<label>Curso a matricularse:</label>
							...
							<?php
							$sql2="SELECT cp.id_cursoparalelo, c.nombre_curso, p.nombre_paralelo ,cp.estado, c.id_curso, p.id_paralelo  FROM curso c , paralelo p, curso_paralelo cp where  cp.fk_curso=c.id_curso and cp.fk_paralelo=p.id_paralelo and cp.id_cursoparalelo='$curso'";
							$result=mysqli_query($conexion,$sql2);
							while($ver2=mysqli_fetch_row($result)): 
...
var formData = new FormData(document.getElementById("frmingreso"));
		...
		$.ajax({
			...
			url:"../procesos/Alumnos/actualizarDatosAlumno.php",
			type: "post",
					dataType: "html",
					data: formData,
					cache: false,
