...
public class CitaProgramada extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cita_programada);
    ...
    private void cargarWebService() {
        String url = "https://dablue40.000webhostapp.com/todaCita.php";
        ...
        try {
            ...
            if (validador){
                ...
                if(lista.size()>0){
                    ...
                    lv = findViewById(R.id.listProgra);
