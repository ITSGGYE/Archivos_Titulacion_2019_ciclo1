...
<html >
    ...
    <body>
        ...
        <form action="guardar_paciente.php" method="POST" enctype="multipart/form-data">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td>NOMBRE</td>
                        <td><input type="text" required name="nombrepac" placeholder="Nombre..." value="" onkeypress="return val(event)" onKeyDown="if (this.value.length == 15 && event.keyCode != 8)
                                    return false;"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>RAZA</td>
                        <td><input type="text" required name="raza" placeholder="Raza..." value="" onkeypress="return val(event)" onKeyDown="if (this.value.length == 15 && event.keyCode != 8)
                                    return false;" />
                        </td>
                    </tr>
                    <tr>
                ...
                <thead>
                    <tr>
                        <th colspan="3">REPRESENTANTE  DUEÑO</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>NOMBRE</td>
                        <td><input type="text" required name="nombrerep" placeholder="Nombre..." value="" onkeypress="return val(event)" onKeyDown="if (this.value.length == 25 && event.keyCode != 8)
                                    return false;"/>
                        </td>
                    </tr>
                    <tr>
                        <td>C.I</td>
                        <td><input type="text" required name="dni" placeholder="C.I.." onkeypress="return val2(event)" onKeyDown="if (this.value.length == 10 && event.keyCode != 8)
                                    return false;" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td>TELÉFONOS</td>
                        <td><input type="tel" required name="telefonos" placeholder="Teléfonos..." value="" onkeypress="return val2(event)" onKeyDown="if (this.value.length == 10 && event.keyCode != 8)
                                    return false;"/>
                        </td>
                    </tr>
                    <tr>
                        <td>DIRECCIÓN</td>
                        <td><input type="text" required name="direccion" placeholder="Dirección..." value="" onKeyDown="if (this.value.length == 50 && event.keyCode != 8)
                                    return false;"/>
                        </td>
                    </tr>
                    <tr>
