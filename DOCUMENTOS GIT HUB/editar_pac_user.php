...
<head>
	...
	<br>
           ...
           <center> ACTUALIZAR DATOS DEL PACIENTE</center>
                         ...
                         <form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit-pac-user.php" method="POST" >
										...
										<div class="control-group">
											<div class="controls">
                                               ...
                                               <a href="act_paciente_user.php" class="btn btn-sm btn-danger">Cancelar</a>
