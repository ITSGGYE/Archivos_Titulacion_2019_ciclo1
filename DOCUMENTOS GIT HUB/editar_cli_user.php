...
<head>
	...
	<br>
           ...
           <center> ACTUALIZAR DATOS DEL PACIENTE</center>
                         ...
                         <form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit-cli-user.php" method="POST" >
										...
										<div class="control-group">
											<div class="controls">
                                               ...
                                               <a href="act_cliente_user.php" class="btn btn-sm btn-danger">Cancelar</a>
