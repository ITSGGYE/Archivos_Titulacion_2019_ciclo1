...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.2 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>SUPER DOC - SISTEMA VETERINARIO</title>
    ...
    <link rel="stylesheet" href="fondo3.css" type="text/css" media="screen" />
    <!-- ************** Menu ********************************-->
  ...
  <nav role='navigation' class="topbar">
    ...
    <ul class="nav">
      <li class="dropdown">
        <a href="#">Inicio</a>
        <ul>
          <li><a href="princ_user.php">Principal</a></li>
      ...
      <li class="dropdown">
        <a href="#">Registros</a>
        <ul>
          <li><a href="registro_paciente_user.php">Registro Pacientes</a></li>
        </ul>
      </li>
      <li class="dropdown">
        <a href="#">Historial</a>
      ...
      <li class="dropdown">
        <a href="#">Reportes</a>
        <ul>
          <li><a href="rep_hist_user.php">Por Atención (PDF)</a></li>
          <li><a href="rep_ficha_user.php">Por Ficha (PDF)</a></li>
