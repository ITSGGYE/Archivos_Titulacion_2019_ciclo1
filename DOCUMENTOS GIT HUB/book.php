...
?></label>
                ...
                <ul id = "menu" class = "nav menu">
                    ...
                    <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "student.php"><i class = "glyphicon glyphicon-book"></i> Registro</a></li>
                    ...
                    <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-tasks"></i> Reportes</a>
                        <ul style = "list-style-type:none;">
                            ...
                            <li><a href = "reporte_general.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-user"></i> General</a></li>
                        </ul>



                    <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "auditoria.php"><i class = "glyphicon glyphicon-home"></i> Auditoria</a></li>
            ...
            <div class = "col-lg-9 well" style = "margin-top:60px;">
                        ...
                        <table id = "table" class = "table table-bordered">
                            ...
                            <tbody>
                                ...
                                while ($fbook = $qbook->fetch_array()) {
                                    ?>
                                    <tr>
                                        <td><?php echo $fbook['book_codigo'] ?></td>
                ...
                <?php
                $result = mysqli_query($conn, "SELECT MAX(book_id)+1 AS id_book FROM db_ls.book");
                $id = mysqli_fetch_array($result);
                $RAND = rand(0, 10);
                $book_id = $RAND . $id['id_book'];
                ?>
                    ...
                    <div class = "col-lg-6">
                        <form method = "POST" action = "save_book_query.php" enctype = "multipart/form-data">
                            ...
                            <div class = "form-group">
                                ...
                                <label>Codigo:</label>
                                <input readonly type = "text" name = "book_codigo" required = "required" value="<?php echo $book_id; ?>" class = "form-control" />
                            </div>
                            <div class = "form-group">
