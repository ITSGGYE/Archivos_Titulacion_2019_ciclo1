                    ...
                    <div class = "col-lg-6">
                        <form method = "POST" action = "save_book_query.php" enctype = "multipart/form-data">
                            ...
                            <div class = "form-group">
                                ...
                                <input type = "text" minlength="4"  name = "book_title" required = "required" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Descripcion:</label>
                                <input type = "text"  name = "book_desc" placeholder = "(Optional)" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Categoria de libro:</label>
                                <input type = "text"  minlength="4" maxlength = "20" name = "book_category" class = "form-control" required = "required"/>
                            </div>
                            <div class = "form-group">
                                <label>Autor:</label>
                                <input type = "text" minlength="4" maxlength = "20" name = "book_author" class = "form-control" required = "required" />
                            </div>
                            <div class = "form-group">
