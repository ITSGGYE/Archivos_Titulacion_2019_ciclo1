...
echo $name; ?></label>
            ...
            <div class = "col-lg-9 well" style = "margin-top:60px;">
                <div class = "alert alert-info">Registro / Estudiantes</div>
                            ...
                            <tbody>
                                ...
                                while ($fstudent = $qstudent->fetch_array()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $fstudent['jornada'] ?></td>
                    ...
                    <div class = "col-lg-6">
                        <form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data">
                            <div class = "form-group">
                                <label>Cédula:</label>
                                <input onkeypress="return soloNumeros(event);" type = "text"  minlength="10" maxlength = "10" name = "student_no" required = "required" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Primer nombre:</label>
                                <input onkeypress="return soloLetras(event);" type = "text" minlength="4" maxlength = "10" name = "firstname" required = "required" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Segundo nombre:</label>
                                <input onkeypress="return soloLetras(event);" type = "text" minlength="4" maxlength = "10" name = "middlename" placeholder = "(Optional)" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Apellidos:</label>
                                <input onkeypress="return soloLetras(event);" type = "text" minlength="4" maxlength = "18" required = "required" name = "lastname" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Curso/Sección:</label>
                                <input onkeypress="return soloMail(event);" type = "text" maxlength = "3" required = "required" name = "course" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Periodo lectivo:</label>
                                <input onkeypress="return soloNumeros(event);" type = "text" maxlength = "4" name = "section" required = "required" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Jornada</label>
