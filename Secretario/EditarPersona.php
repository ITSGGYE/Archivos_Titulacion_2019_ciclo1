...
<html>
    <head>
        ...
        <script src="../js/ListadoPersonas.js" type="text/javascript"></script>
        <script src="../js/EliminarPersona.js" type="text/javascript"></script>
        <script src="../js/FiltroPersona.js" type="text/javascript"></script>
        <script src="../js/EditarPersona.js" type="text/javascript"></script>
    ...
    <body>
        ...
        require '../Models/Modelo_ConsultaPersonaCedula.php';
        ...
        $data = ConsultarPersona($id, $conexion)
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Formulario Personas</li>
                </ol>
            </div><!--/.row-->



            <div class="panel-container" style="padding: 30px;">

                <div class="row" style="border: 1px solid #999999;background: #FFFFFF;padding-top: 25px;">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="per_cedula" value="<?= $data['per_cedula'] ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="per_nombre" value="<?= $data['per_nombre'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="per_direccion" value="<?= $data['per_direccion'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control" id="per_fecha_nac" value="<?= $data['per_fecha_nac'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="per_lugarNacimiento" value="<?= $data['per_lugarNacimiento'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="email" class="form-control" id="per_correo" value="<?= $data['per_correo'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="per_telefono" value="<?= $data['per_telefono'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="per_nombresPadre" value="<?= $data['per_nombresPadre'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="per_nombresMadre" value="<?= $data['per_nombresMadre'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" id="per_observacion" value="<?= $data['per_observacion'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3 col-lg-offset-5" style="margin-bottom: 10px;">
                            <button class="btn btn-primary btn-lg btn-block" onclick="EditarPersona()" ><i class="fa fa-save"></i> Registrar</button>
