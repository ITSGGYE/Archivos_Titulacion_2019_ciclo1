...
<div>
 <form  class="modal-content"   method="POST" id="addcategory"  enctype="multipart/form-data" action="php/registroforo.php" role="form">
...
<hr><br><br>
    <div class="form-group">
      <div class="col-lg-offset-2 col-lg-10">
        <button type="submit" class="btn btn-primary">Agregar Foro</button>
      </div>
    </div>
  </form>
