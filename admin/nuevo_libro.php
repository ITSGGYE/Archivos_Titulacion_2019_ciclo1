...
$consulta4="SELECT anio from usuario_estudiante";
$anio=mysqli_query($conexion, $consulta4);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
     ...
     <form action="libros_biblioteca/recibirlibros.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
       <table class="table table-bordered table-condensed table-responsive table-striped table-hover" width="79%" border="1">
        ...
        <tr>
            <td>CURSOS </td>
              <td>   <select name="anio" id="proveedor" class="form-control" requerid>
                                     <option value="1">1ro. de basica</option>
                                     <option value="2">2do. de basica</option>
                                     <option value="3">3ro. de basica</option>
                                     <option value="4">4to. de basica</option>
                                     <option value="5">5to. de basica</option>
                                     <option value="6">6to. de basica</option>
                                     <option value="7">7to. de basica</option>
                                </select>
             </td>
       </tr> 
       <tr>
