...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Factura</h1>
			<address >
				<h1>Hostal El Parque</h1>
				<p>El cabezal en la provincia de Santa Elena,<br>Batusai,<br>Sri Lanka.</p>
				<p>(+94) 65 222 44 55</p>
				<br><p>042942305</p>
			</address>
			<span><img alt="" src="assets/img/hostal.png"></span>
		</header>
		<article>
			<h1>	Recipiente</h1>
			<address >
			...
			<table class="inventory">
				<thead>
					<tr>
						<th><span >Habitacion</span></th>
						<th><span >tienpo</span></th>
		...
		<aside>
			<span><img alt="ZATA" src="assets/img/zata5.png"  width="120" height="120"></span>
			<span><img alt="ZATA" src="assets/img/zata.png"  width="120" height="120"></span>
			<h1><span >Contáctenos</span></h1>
			<div >
				<p align="center">Email :-ZATA@sgmail.com || Web : SOLUICIONES ZATA || Phone :- +94 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
