...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Pedidos	</h2></center></div>
			<br />
			<!--<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Buscar transacciones aquí..." id="filter"></label>-->
			<br />
			...
			<!--		<th>ID</th>-->
				...
				//echo "<script>alert(".$date.");</script>";
					...
					$query = mysqli_query($conn, "SELECT * FROM transaction,customer WHERE customer.customerid = transaction.customerid  AND transaction.order_stat = 'Confirmado' AND order_date = '$date'  ORDER BY order_date DESC") or die(mysqli_error());
					while($fetch = mysqli_fetch_array($query))
						...
						$name = $fetch['primer_nombre'].' '.$fetch['apellido'];
				?>
				<tr>
				<!--	<td><?php echo $id; ?></td>-->
					...
					<td><a href="receipt.php?tid=<?php echo $id; ?>">Ver</a>
					<?php
