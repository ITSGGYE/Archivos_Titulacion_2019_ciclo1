...
*</label>
                                            <select name="troom"  class="form-control" required>
                                                ...
                                                <option value="Superior Room">Sensilla</option>
                                                <option value="Deluxe Room">Semi-Sensilla</option>
												<option value="Guest House">vip</option>
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										if($data[0] > 1) {
											echo "<script type='text/javascript'> alert('Habitación ya en existencia')</script>";
										...
										{
										 echo '<script>alert("Nueva sala agregada") </script>' ;
										}else {
