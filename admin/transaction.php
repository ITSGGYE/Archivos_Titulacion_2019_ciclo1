	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<!--		<th>ID</th>-->
				...
				//echo "<script>alert(".$date.");</script>";
					...
					$query = mysqli_query($conn, "SELECT * FROM transaction,customer WHERE customer.customerid = transaction.customerid AND transaction.order_date = '$date' AND transaction.order_stat = 'En Espera' ORDER BY order_time ASC") or die(mysqli_error());
				...
				<!--	<td><?php echo $id; ?></td>-->
					...
					<td><a href="receipt_1.php?tid=<?php echo $id; ?>">Ver</a>
					<?php
					if($o_stat == 'Confirmed'){
