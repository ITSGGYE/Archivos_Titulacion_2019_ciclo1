	...
	<div id="leftnav">
		<ul>
			...
			<li><a href="admin_home.php">Productos</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Ofertas</a></li>
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Bebidas</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">Snacks</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">Cigarrillos y Caramelos</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
		...
		<div class="alert alert-info">
			<table class="table table-hover">
				...
				?>
				<tr>
					<td><?php echo $fetch['primer_nombre'];?>&nbsp;<?php echo $fetch['segundo_nombre'];?>&nbsp;<?php echo  $fetch['apellido'];?></td>
					<td><?php echo $fetch['direccion']?></td>
					<td><?php echo $fetch['pais']?></td>
					<td><?php echo $fetch['codigo_postal']?></td>
					<td><?php echo $fetch['movil']?></td>
					<td><?php echo $fetch['telefono']?></td>
					<td><?php echo $fetch['email']?></td>
					<td><a href="./down.php?email=<?php echo $fetch['email'];?>">DAR DE BAJA</a>
				</tr>
				<?php
					}
				?>
