<?php
    ...
    $nroProductos = mysqli_num_rows(mysqli_query("SELECT pedidos.id, clientes.usuario, pedidos.fecha, pedidos.estado, lineaspedido.unidades, productos.nombre, productos.precio
FROM pedidos
...
INNER JOIN productos ON lineaspedido.idproducto = productos.id"));
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query("SELECT pedidos.id, clientes.usuario, pedidos.fecha, pedidos.estado, lineaspedido.unidades, productos.nombre, productos.precio
FROM pedidos
INNER JOIN clientes ON pedidos.idcliente = clientes.id
INNER JOIN lineaspedido ON lineaspedido.idpedido = pedidos.id
INNER JOIN productos ON lineaspedido.idproducto = productos.id");
