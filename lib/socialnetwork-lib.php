...
<header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>RED</b>COLGYE</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="chat.php">
            <i class="fa fa-comment"></i> <span>Foro</span>
        ...
        <li>
          <a href="index.php">
            <i class="fa fa-user"></i> <span>Videos Educativos</span>
          </a>
        </li>
        <li>
          <a href="index.php">
            <i class="fa fa-arrow-right"></i> <span>Juegos Educativos</span>
          </a>
        </li>
        <li>
          <a href="index.php">
            <i class="fa fa-heart"></i> <span>Videos Educativos</span>
          </a>
        </li>
          </ul>
        </li>
