    ...
    <table class="table table-bordered table-condensed table-responsive table-striped table-hover"  width="1300" border="0">
           <tr> 
             ...
             <tr>
                 ...
                 <td bgcolor="#D6D6D6" class="colorencabezado"><b>Tamaño</b></td>
                 <td bgcolor="#D6D6D6" class="colorencabezado"><b>Acciones</b></td>
            </tr>
                  <?php 
                      $consulta=mysqli_query($conexion, "SELECT l.id_libro as id_libro,p.id_pdf as idp, l.foto as foto,l.nombre as nombre,p.titulo as descripcion,p.tamanio as disponible FROM libros l, pdf p where l.id_libro=p.id_libro");
                        if (isset($_POST['txtbuscar'])){
                       $consulta=mysqli_query($conexion, "SELECT l.id_libro as id_libro,p.id_pdf as idp, l.foto as foto,l.nombre as nombre,p.titulo as descripcion,p.tamanio as disponible from libros l, pdf p where l.id_libro=p.id_libro and nombre like '%".$_POST['txtbuscar']."%'  "); 
                      }
            ...
            <tr>
               ...
               <td width="50"><?php echo $disponible ?></td>
                <td><button class="btn btn-warning"><a href="admin/pdf/archivo.php?id=<?php echo $filas['idp']?>"><b>Ver</b></a></button></td>
               <td width="220">
