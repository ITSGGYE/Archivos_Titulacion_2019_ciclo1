<?php
 ...
 require '../Conexion/functions.php';
    ...
    INNER JOIN iglesia IG ON IG.igle_codigo = SC.sac_iglesia WHERE PAR.par_tipo_persona='S' AND PER.per_nombre LIKE '%$nombreParticipante%' ";
    ...
    while($data = $statement->fetch(PDO::FETCH_ASSOC)){
        ...
        $listaFiltroNombre[]= $data;
    } 
     
    echo json_encode($listaFiltroNombre);
