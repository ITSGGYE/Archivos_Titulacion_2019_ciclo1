...
$sql=" SELECT ES.nombresEstudiante,MC.nombrecalif,NE.idseqParcial,PC.nombreParcial,NE.Nota 
...
and NE.idRango='$idRango' and NE.idPeriodo='$idPeriodo' AND ES.nombresEstudiante='$nombreEstudiante'
...
while($data = $statement->fetch(PDO::FETCH_ASSOC)){
    ...
    $listaNotasEstudianteFamiliar[] = $data;
    
}
echo json_encode($listaNotasEstudianteFamiliar);
