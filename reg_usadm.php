...
<html >
    ...
    <body>
        ...
        <form name="usuarios" action="guardar_usadm.php" method="post">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="email" value="" placeholder="Escribe el login.."  size="45" required></td>

                    </tr>
                    <tr>
                        <td class="tdatos">Password:</td>
                        <td><input minlength="5" maxlength="8" type="password" name="pasadmin" value="" placeholder="" size="45" required></td>

                    </tr>
                    <tr>
                        <td class="tdatos">Repetir Password:</td>
                        <td><input minlength="5" maxlength="8" type="password" name="r_pasadmin" value="" placeholder="" size="45"></td>
