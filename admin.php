                ...
                <div id = "admin_table">
                    <div class="table-responsive">
                        <table id = "table" class = "table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $q_admin = $conn->query("SELECT * FROM `admin` WHERE username != 'AdministradorCF2019'") or die(mysqli_error());
                    ...
                    <div class = "col-lg-6">
                        <form method = "POST" action = "save_admin_query.php" enctype = "multipart/form-data">
                            <div class = "form-group">
                                <label>Usuario:</label>
                                <input type = "text" minlength="4" maxlength = "20" required = "required" name = "username" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Contraseña:</label>
                                <input type = "password" minlength="5" maxlength = "15" name = "password" required = "required" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Primer nombre:</label>
                                <input type = "text" minlength="4" maxlength = "15" name = "firstname" required = "required" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Segundo nombre:</label>
                                <input type = "text" minlength="4" maxlength = "15" name = "middlename" placeholder = "(Optional)" class = "form-control" />
                            </div>
                            <div class = "form-group">
                                <label>Apellidos:</label>
                                <input type = "text" minlength="4" required = "required" name = "lastname" class = "form-control" />
                            </div>
                            <div class = "form-group">
