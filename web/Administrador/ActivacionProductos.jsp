...
<%@page import="Models.ModelsListadoProductos"%>
...
<html>
    <head>
        ...
        <script src="../js/EditarEstado.js" type="text/javascript"></script>
        <script src="../js/ActivarProductos.js" type="text/javascript"></script>
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="ListadoPeticiones.jsp" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="ActivacionProductos.jsp" class="nav-link active">
                                    ...
                                    <table class="table table-bordered" style="background:white;">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                ArrayList<Producto> objListProductos = ModelsListadoProductos.ListadoProductos();

                                                for (Producto c : objListProductos) {%>
                                        ...
                                        <tbody class="buscar">
                                            <tr>
                                                ...
                                                <td><%=c.getEstado()%></td>
                                                <td>
                                                    <input type="hidden" value="A" id="ActivarEstado">
                                                    <button class="btn btn-success" style="width: 130px;" onclick="btnActivarEstado(<%=c.getId()%>)"><i class="fa fa-edit"></i> Activar</button>
                                                    
                                                    
                                                    <input type="hidden" value="I" id="InactivarEstado">
                                                    <button class="btn btn-danger" style="width: 130px;margin-left: 1px;" onclick="btnInactivarEstado(<%=c.getId()%>)"><i class="fa fa-edit"></i> Inactivar</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <%}%> 
