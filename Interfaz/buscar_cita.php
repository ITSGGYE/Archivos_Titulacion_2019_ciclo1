...
$consulta = $conexion -> prepare("
		SELECT 	* FROM citas WHERE (idcita LIKE '$busqueda' OR
		citfecha LIKE '$busqueda' OR
		cithora LIKE '$busqueda' OR
		citestado LIKE '$busqueda' OR
		citPaciente LIKE '%$busqueda%' OR
		citMedico LIKE '%$busqueda%')");
    ...
    ?>
				...
				<article>
					...
					<form action= "buscar_cita.php" method="post" class="form_search">
						<input type="text" name="busqueda" id="busco
