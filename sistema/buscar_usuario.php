 ...
 <body>
 	...
 	<section id="container">
 		...
 		<?php
 			...
 			$query = mysqli_query($conection,"SELECT nombres,cedula,user,nombre_rol,usuarios.id,usuarios.rol FROM personas,usuarios,roles WHERE usuarios.rol = roles.type_rol AND usuarios.estatus = 1 AND usuarios.user = '$usuario' AND usuarios.cedula_usuario = personas.cedula ORDER BY usuarios.id ASC LIMIT $desde,$por_pagina
 				");
