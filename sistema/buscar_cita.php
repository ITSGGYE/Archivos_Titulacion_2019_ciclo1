 ...
 <body>
 	...
 	<section id="container">
 		...
 		<?php
 			...
 			$query = mysqli_query($conection,"SELECT citas.id,citas.fecha,citas.hora,personas.nombres,citas.cedula_paciente,citas.nota FROM citas, personas  where citas.cedula_paciente = personas.cedula AND citas.fecha = '$newFecha' AND citas.estatus = 1 ORDER BY citas.id ASC LIMIT $desde,$por_pagina
 				 ");
