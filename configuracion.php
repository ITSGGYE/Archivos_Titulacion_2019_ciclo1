...
<head>
    ...
    <title>Configuración | Sistema de Matricula y Pensión</title>
...
echo '<div class="alert alert-success">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Éxito!</strong> Contraseña cambiada Satisfactoriamente.</div>';
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="panel panel-primary">
                            ...
                            <form action="configuracion.php" method="post" id="signupForm1" class="form-horizontal">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#signupForm1").validate({
                    ...
                    messages: {
                        oldpassword: "Por favor ingrese su contraseña anterior",

                        newpassword: {
                            required: "Por favor proporcione una contraseña",
                            minlength: "Tu contraseña debe de tener por lo menos 6 caracteres."
                        },
                        confirmpassword: {
                            required: "Por favor proporcione una contraseña",
                            minlength: "Tu contraseña debe de tener por lo menos 6 caracteres.",
