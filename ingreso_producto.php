...
<section>
	<div class="container-fluid">
    	<div class="container">
        <div class="col-sm-12">
                        	<h1 class="titulo_h1">Ingreso Producto</h1>
                         </div>
        	<div class="form-box">
                         	...
                         	<div class="col-sm-4">
                            	<div class="inputbox">
                                	<div class="InputText ">Nombre Producto</div>
                                    	<input type="text" name="nproducto" autofocus id="nproducto" class="input"  onKeyUp='mayus(this)' onKeyPress='return soloLetras(event)'/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                            	<div class="inputbox">
                                <div class="InputText focus">Precio Producto</div>
                                    	<input type="text" name="precio" id="precio" maxlength="6" class="input"  onblur="return NumCheck(event, this)" onKeyPress='return soloNumeros(event)'/>
                         	...
                         	<div class="col-sm-4">
                                    ...
                                    <div class="custom-select" style="width:200px;">
                                          <select class="input" name="variedad">
											...
											//Ingreso de los tipos de productos a elegir de la tabla tipo productos
											 while ($row = mysqli_fetch_row($result_variedad)){ 
                               ...
                               <div class="col-sm-4">
                            	<div class="inputbox">
                                    ...
                                    <input type="text" name="peso" id="peso" maxlength="2" class="input" onKeyPress='return soloNumeros(event)' />
                                 </div>
                               </div>
                             <div class="col-sm-4">
                            	<div class="inputbox">
      ...
      <div data-wysihtml5-dialog="insertImage" style="display: none;">
        ...
        <a data-wysihtml5-dialog-action="save">OK</a>&nbsp;<a data-wysihtml5-dialog-action="cancel">Cancel</a>
										...
										<textarea id="wysihtml5-editor" name="descripcion" spellcheck="false" wrap="off"  placeholder="Ingrese descripcion del producto ..." class="input"></textarea>
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-sm-6" align="center">
                            	<div class="inputbox">
                          			<input  type="reset" name="cancelar" value="Cancelar" class="btton btn-lg text-center" />
                                </div>
                            </div>
                          </div>
                     </div>
