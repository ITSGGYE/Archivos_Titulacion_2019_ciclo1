...
<html>
    <head>
        ...
        <script src="../js/EliminarUsuario.js" type="text/javascript"></script>
        <script src="../js/FiltroUsuario.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="panel-container" style="padding: 30px;">
                <div class="col-md-12">
                    <div class="col-md-4">
                                <input type="text" id="filtroUsuario" class="form-control" placeholder="INGRESE EL TEXTO A FILTRAR">
                            </div>
                </div>
                <div class="col-md-12">
