...
<html>
    <head>
        ...
        <title>Mantenimiento Iglesia</title>
        ...
        <script src="../js/cargar_iglesia.js" type="text/javascript"></script>
        <script src="../js/Guardar_Mantenimiento.js" type="text/javascript"></script>
       ...
       <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="parent active"><a href="form_MantenimientoIglesia.php"><em class="fa fa-user">&nbsp;</em> Mantenimiento</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Mantenimiento / Formulario Mantenimiento</li>
                </ol>
            </div><!--/.row-->
            ...
            <div class="panel-container">
                <div class="col-md-12">
                    ...
                    <div class="col-md-7">
                        <h1 class="page-header" style="font-size: 2em;text-align: center;">Formulario Mantenimiento</h1>
                    </div>
                </div>
                <div class="col-md-12">
                    ...
                    <div class="col-md-7" id="formularioHistorial">
                        ...
                        <input type="hidden" id="igle_usuario" value="<?php print_r($nombre) ?>">
                        <input type="hidden" id="igle_fechaModificacion" value="<?php print_r($fecharegistro) ?>">

                        <div class="form-inline" >
                            <div class="col-md-2 col-sm-offset-3" Style="margin-top: 15px">
                                <button class="btn btn-success" onclick="GuardarMantenimiento()"><i class="fa fa-save"></i> GUARDAR</button>

                            </div>
                            <div class="col-md-2 col-sm-offset-1" style='margin-top: 15px'>
                                <button class="btn btn-danger" id="btnCancelar"><i class="fa fa-times"></i> CANCELAR</button>
                            </div>
                        </div><!--// form-inline // -->
