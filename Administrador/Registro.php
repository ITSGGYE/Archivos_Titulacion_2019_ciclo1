...
<html>
    <head>
        ...
        <script src="../js/Guardar_Usuario.js" type="text/javascript"></script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-7" id="formularioHistorial">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" placeholder="*****" id="password" style="margin-top: 20px;position: relative;">
                            </div>


                        </div>
                        <button class="btn btn-primary btn-lg btn-block" onclick="GuardarUsuario()" >Registrar</button>
