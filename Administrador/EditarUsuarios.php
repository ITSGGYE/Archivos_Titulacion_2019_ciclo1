...
<html>
    <head>
        ...
        <script src="../js/llenarComboRol.js" type="text/javascript"></script>
        <script src="../js/GuardarModUsuario.js" type="text/javascript"></script>
    ...
    <body>
        ...
        require '../Models/Modelo_ConsultaUsuarioId.php';
        ...
        $data = ConsultarUsuariosId($id, $conexion)
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="panel-container" style="padding: 30px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-10">
                        <h1 class="page-header" style="font-size: 2em;text-align: center;">Editar Usuario</h1>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="col-md-3"> </div><!--// col-md-2// -->
                    <div class="col-md-7" id="formularioHistorial">
                        <div class="form-group" id="form">
                            ...
                            <div class="col-md-6">
                                <input type="hidden" class="form-control" placeholder="Username" id="idusuario" value="<?= $data['idusuario'] ?>">

                                <input type="text" class="form-control" placeholder="Username" id="usuario" value="<?= $data['usuario'] ?>">

                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                                <label ><span>*</span> Tipo Usuario</label>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="password" value="<?= $data['password'] ?>" style="margin-top: 20px;position: relative;">
                            </div>


                        </div>
                        <button class="btn btn-primary btn-lg btn-block" onclick="EditarUsuario()" ><i class="fa fa-save"></i>Registrar</button>
