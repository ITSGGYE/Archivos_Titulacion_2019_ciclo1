<html>
    <head>
        ...
        <script src="../js/Consultar_Materias.js" type="text/javascript"></script>
        <script src="../js/cargarNom_Materia_Profesor.js" type="text/javascript"></script>
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h3 mb-2 text-gray-800">
                            <div class="form-inline">
                                ...
                                <div class="col-sm-2">
                                    <h6 style="margin-top: 12px;color:#8c8c8c">Ingreso Notas</h6>   
                                </div>
                            </div>
                        </h1>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class='form-inline'>
                                    <div class='col-md-6'>
                                        <h4 class="m-2 font-weight-bold text-primary"><i class='fa fa-book'></i> Cursos</h4>
                                    </div> 
                                    <div class='col-md-6'>
                                ...
                                <div class="col-md-12" style='margin-top: 20px;'>
                                    <div class="form-inline">
                                        ...
                                        <div class="col-sm-2">
                                            <button class="btn btn-primary" onclick="BuscarMateria()" style='width: 150px;'><i class="fa fa-search"></i> Buscar</button>
                                        </div>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 style="text-align: center;">Modelos de Calificación</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12" id="tablaModeloCalificacion">
                                ...
                                <div class="modal-footer">
                                    <button type="button" id="btnSalir"  class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Cerrar</button>
                                </div>
                            </div>
                        </div>
                    </div>
