<html>
    <head>
        ...
        <script src="../js/llenarComboProfesor.js" type="text/javascript"></script>
         <script src="../js/Consulta_Asistencia.js" type="text/javascript"></script>
                                ...
                                <div class='col-md-12'>
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-inline">
                                            ...
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary" onclick="consultaAsistencia()" ><i class="fa fa-search"></i></button>
                                            </div>
