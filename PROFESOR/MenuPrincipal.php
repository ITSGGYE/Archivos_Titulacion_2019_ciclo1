    ...
    <body id="page-top" >
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="Asistencia" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="PROFESOR/IngresoAsistencias.php">Ingreso</a>
                            <a class="collapse-item" href='PROFESOR/Listado_AsistenciaEstudiante.php'>Consulta</a>
                ...
                <!-- Nav Item - Tables -->
                <li class="nav-item">
                    <a class="nav-link" href="PROFESOR/EnviarCorreoElectronico.php">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="PROFESOR/IngresoNotas.php">Ingresar Notas</a>
                            <a class="collapse-item" href="PROFESOR/ListadoNotas.php">Listado Notas</a>
                        </div>
                    </div>
                </li>
                <!-- Nav Item - calendar -->
                <li class="nav-item">
                    <a class="nav-link" href="PROFESOR/CalendarioWeb.php">
